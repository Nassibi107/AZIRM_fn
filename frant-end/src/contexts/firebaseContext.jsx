...
import { getAuth, signOut, signInWithPopup, GoogleAuthProvider, onAuthStateChanged, 
  signInWithEmailAndPassword, createUserWithEmailAndPassword } from "firebase/auth"; // CUSTOM COMPONENT
...
const getRole = (r) => {setRole(r)}; // role CONTEXT INITIALIZE
