...
const images = [
    {
        id: 1,
        link: '/static/latestLiveStream/dtch.png'
    },
    {
        id: 2,
        link: '/static/latestLiveStream/mdr.png'
    },
    {
        id: 3,
        link: '/static/latestLiveStream/prs.png'
    },
    {
        id: 4,
        link: '/static/latestLiveStream/rberl.png'
    },
]

const LatestLiveStream = ({
    navigation,
    pagination,
    ...props
    }) => {
            ...
            >
                {images.map((img) => (
                    <SwiperSlide key={img.id}>
                        <img src={img.link} alt={`Slide ${img.link}`} style={{width:"100%"}}/>
                    </SwiperSlide>
                ))}
            </Swiper>
