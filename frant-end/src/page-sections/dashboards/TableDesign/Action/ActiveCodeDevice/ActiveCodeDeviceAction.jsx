...
import PreviewActiveCodeDeviceModal from './PreviewActiveCodeDeviceModal'
import EditActiveCodeDeviceModal from './EditActiveCodeDeviceModal'

const ActiveCodeDeviceAction = ({ dataRow, reloader }) => {
    ...
    <>
        ...
        <PreviewActiveCodeDeviceModal setIsEdit={setIsEdit} isPriview={isPriview} handlePreview={handlePreview} dataRow={dataRow} />
        <EditActiveCodeDeviceModal isEdit={isEdit} handlePreview={handlePreview} dataRow={dataRow} reloader={reloader}/>
    </>
  )
};

export default ActiveCodeDeviceAction;
