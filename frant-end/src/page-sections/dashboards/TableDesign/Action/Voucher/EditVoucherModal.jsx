...
const EditVoucherModal = ({ isEdit, handlePreview, dataRow, reloader}) => {
    ...
    async function editReward(editContent) {
        try {
          const response = await axios.put(`${import.meta.env.VITE_LV_URL}/vouchers/${dataRow.id}`, qs.stringify(editContent), {
            headers: {
