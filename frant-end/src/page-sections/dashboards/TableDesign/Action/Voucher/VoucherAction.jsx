...
import PreviewVoucherModal from './PreviewVoucherModal'
import EditVoucherModal from './EditVoucherModal'

const VoucherAction = ({ dataRow, reloader }) => {
    ...
    <>
        ...
        <PreviewVoucherModal isPriview={isPriview} handlePreview={handlePreview} dataRow={dataRow} />
        <EditVoucherModal isEdit={isEdit} handlePreview={handlePreview} dataRow={dataRow} reloader={reloader}/>
    </>
  )
};
