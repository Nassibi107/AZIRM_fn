...
import PreviewRewardProgramModal from './PreviewRewardProgramModal'
import EditRewardProgramModal from './EditRewardProgramModal'

const RewardProgramAction = ({ dataRow, reloader }) => {
    ...
    <>
        ...
        <PreviewRewardProgramModal isPriview={isPriview} handlePreview={handlePreview} dataRow={dataRow} />
        <EditRewardProgramModal isEdit={isEdit} handlePreview={handlePreview} dataRow={dataRow} reloader={reloader}/>
    </>
  )
};

export default RewardProgramAction;
