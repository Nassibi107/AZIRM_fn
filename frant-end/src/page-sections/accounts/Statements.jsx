    ...
    pb: 2
      ...
      <Box padding={3}>
        ...
        <EarningBoxWrapper flexWrap="wrap" pt={2}>
          ...
          <Button variant="contained">total $4,550</Button>
        </EarningBoxWrapper>
      </Box>
        ...
        minWidth: 800
          ...
          <TableHead>
            <TableRow>
              ...
              <StyledHeadTableCell>Donation ID</StyledHeadTableCell>
              <StyledHeadTableCell>Donation Details</StyledHeadTableCell>
