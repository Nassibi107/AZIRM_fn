     ...
     }) 
{
    ...
    const getBouquetsApi = async () => {
        try
        {
            const  resBqLive =  await axios.get(`${API_URLS}/packages/${idPack}/bouquets?filters[is_children][type]=live`) ;
            const  resBqSeries =  await axios.get(`${API_URLS}/packages/${idPack}/bouquets?filters[is_children][type]=serie`) ;
            const  resBqMovie =  await axios.get(`${API_URLS}/packages/${idPack}/bouquets?filters[is_children][type]=movie`) ;
            const [LiveIds , SerieIds , MoviesIds ] = await Promise.all([
                axios.get(`${API_URLS}/packages/${idPack}/bouquets?filters[is_children][type]=live`),
                axios.get(`${API_URLS}/packages/${idPack}/bouquets?filters[is_children][type]=serie`),
                axios.get(`${API_URLS}/packages/${idPack}/bouquets?filters[is_children][type]=movie`)
            ])
