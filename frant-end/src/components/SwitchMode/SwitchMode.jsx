...
const SwitchMode = styled(Switch)(({ theme }) => ({
    ...
    '& .MuiSwitch-switchBase': {
      ...
      '&.Mui-checked': {
        ...
        '& + .MuiSwitch-track': {
          ...
          // Use the theme's mode to switch between dark and light themes
    ...
    '& .MuiSwitch-thumb': {
      ...
      // Use the theme's mode to switch thumb color as well
    ...
    '& .MuiSwitch-track': {
      ...
      backgroundColor: '#aab4be',
      borderRadius: 20 / 2,
      // Use the theme's mode for the track color
      backgroundColor: theme.palette.mode === 'dark' ? '#8796A5' : '#e0e0e0',
    },
  }));
